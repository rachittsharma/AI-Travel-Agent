    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full glass-panel p-8 rounded-3xl border border-white/10 shadow-2xl relative">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">Unlock AI travel planning, flight deals, and trip history</p>
        </div>
        ...
        <div className="mt-6 pt-6 border-t border-dark-border text-center text-xs text-slate-400">
          ...
          <Link href="/login" className="text-sky-400 hover:text-sky-300 font-semibold ml-1">
            Log In
          </Link>
        </div>
      </div>
